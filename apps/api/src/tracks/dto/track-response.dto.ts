...
export class SanitizedTrackDto {
  ...
  @ApiProperty({
    example: true,
    description:
      "Indicates whether track metadata and platform links have been manually verified",
  })
  isVerified!: boolean;
  ...
  @ApiProperty({
    example: true,
    description:
      "Whether synchronized or plain text lyrics exist in the database for this track",
  })
  hasLyrics!: boolean;
